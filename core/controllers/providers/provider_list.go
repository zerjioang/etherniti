...
func newController(client *client.EthClient, connection *network.NodeConnection) RestController {
...
// constructor like function
func newInfuraController(client *client.EthClient, connection *network.NodeConnection, fallbackConnStr string) RestController {
...
// constructor like function
func NewRopstenController(client *client.EthClient) RestController {
...
// constructor like function
func NewRinkebyController(client *client.EthClient) RestController {
...
// constructor like function
func NewKovanController(client *client.EthClient) RestController {
...
// constructor like function
func NewMainNetController(client *client.EthClient) RestController {
