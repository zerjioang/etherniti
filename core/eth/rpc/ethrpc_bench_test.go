...
type EthRPCBenchSuite struct {
	suite.Suite
	rpc *EthRPC
}

func (s *EthRPCBenchSuite) registerResponse(result string, callback func([]byte)) {
	httpmock.Reset()
...
func (s *EthRPCBenchSuite) registerResponseError(err error) {
	httpmock.Reset()
	httpmock.RegisterResponder("POST", s.rpc.url, func(request *http.Request) (*http.Response, error) {
		return nil, err
	})
...
func (s *EthRPCBenchSuite) methodEqual(body []byte, expected string) {
	value := gjson.GetBytes(body, "method").String()

	s.Require().Equal(expected, value)
}

func (s *EthRPCBenchSuite) paramsEqual(body []byte, expected string) {
...
func (s *EthRPCBenchSuite) TearDownSuite() {
	httpmock.Deactivate()
}

func (s *EthRPCBenchSuite) TearDownTest() {
	httpmock.Reset()
}

func (s *EthRPCBenchSuite) TestURL() {
	s.Require().Equal(s.rpc.url, s.rpc.URL())
}

func (s *EthRPCBenchSuite) TestWeb3ClientVersion() {
...
func (s *EthRPCBenchSuite) TestWeb3Sha3() {
...
func (s *EthRPCBenchSuite) TestNetVersion() {
...
func (s *EthRPCBenchSuite) TestNetListening() {
...
func (s *EthRPCBenchSuite) TestEthProtocolVersion() {
...
func (s *EthRPCBenchSuite) TestEthSyncing() {
	s.registerResponseError(errors.New("Error"))
...
func (s *EthRPCBenchSuite) TestEthCoinbase() {
...
func (s *EthRPCBenchSuite) TestEthMining() {
...
func (s *EthRPCBenchSuite) TestEthGasPrice() {
	s.registerResponseError(errors.New("Error"))
...
func (s *EthRPCBenchSuite) TestEthAccounts() {
	s.registerResponse(`["0x407d73d8a49eeb85d32cf465507dd71d507100c1"]`, func(body []byte) {
...
func (s *EthRPCBenchSuite) TestEthBlockNumber() {
	s.registerResponseError(errors.New("Error"))
...
func (s *EthRPCBenchSuite) TestEthGetBalance() {
...
func (s *EthRPCBenchSuite) TestEthGetStorageAt() {
...
func (s *EthRPCBenchSuite) TestEthGetTransactionCount() {
	address := "0x407d73d8a49eeb85d32cf465507dd71d507100c1"
	s.registerResponseError(errors.New("Error"))
...
func (s *EthRPCBenchSuite) TestEthGetBlockTransactionCountByHash() {
...
func (s *EthRPCBenchSuite) TestEthGetBlockTransactionCountByNumber() {
	number := 2384732
	s.registerResponseError(errors.New("Error"))
...
func (s *EthRPCBenchSuite) TestEthGetUncleCountByBlockHash() {
	hash := "0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238"
	s.registerResponseError(errors.New("Error"))
...
func (s *EthRPCBenchSuite) TestEthGetUncleCountByBlockNumber() {
	number := 3987434
	s.registerResponseError(errors.New("Error"))
...
func (s *EthRPCBenchSuite) TestEthGetCode() {
...
func (s *EthRPCBenchSuite) TestEthSign() {
...
func (s *EthRPCBenchSuite) TestEthSendRawTransaction() {
...
func (s *EthRPCBenchSuite) TestEthGetCompilers() {
...
func (s *EthRPCBenchSuite) TestEthGetBlockByHash() {
	// Test with transactions
	hash := "0x111"
...
func (s *EthRPCBenchSuite) TestEthGetBlockByNumber() {
	// Test with transactions
	number := 3274863
	s.registerResponse(`{}`, func(body []byte) {
...
func (s *EthRPCBenchSuite) TestEthCall() {
...
func (s *EthRPCBenchSuite) TestGetTransaction() {
	result := `{
...
func (s *EthRPCBenchSuite) TestEthGetTransactionByHash() {
	s.registerResponse(`{}`, func(body []byte) {
...
func (s *EthRPCBenchSuite) TestEthGetTransactionByBlockHashAndIndex() {
	s.registerResponse(`{}`, func(body []byte) {
...
func (s *EthRPCBenchSuite) TestEthGetTransactionByBlockNumberAndIndex() {
	s.registerResponse(`{}`, func(body []byte) {
...
func (s *EthRPCBenchSuite) TestEthNewFilterWithAddress() {
...
func (s *EthRPCBenchSuite) TestEthNewFilterWithTopics() {
	topics := [][]string{
		{
...
func (s *EthRPCBenchSuite) TestEthNewFilterWithAddressAndTopics() {
	topics := [][]string{
		{"0xb2b2eeeee341e560da3d439ef5e5309d78a22a66"},
		{"0xb2b2fffff341e560da3d439ef5e5309d78a22a66"},
	}
...
func (s *EthRPCBenchSuite) TestEthNewBlockFilter() {
	result := "0x6996a3a4788d4f2067108d1f536d4330"
	s.registerResponse(fmt.Sprintf(`"%s"`, result), func(body []byte) {
...
func (s *EthRPCBenchSuite) TestEthNewPendingTransactionFilter() {
	result := "0x153"
	s.registerResponse(fmt.Sprintf(`"%s"`, result), func(body []byte) {
...
func (s *EthRPCBenchSuite) TestEthGetFilterChanges() {
...
func (s *EthRPCBenchSuite) TestEthGetFilterLogs() {
	filterID := "0x6996a3a4788d4f2067108d1f536d4330"
	result := `[{
		"address": "0xaca0cc3a6bf9552f2866ccc67801d4e6aa6a70f2",
		"blockHash": "0x9d9838090bb7f6194f62acea788688435b79cc44c62dcf1479abd9f2c72a7d5c",
...
func (s *EthRPCBenchSuite) TestEthGetLogs() {
	params := FilterParams{
		FromBlock: "0x1",
		ToBlock:   "0x10",
...
func (s *EthRPCBenchSuite) TestEthUninstallFilter() {
	filterID := "0x6996a3a4788d4f2067108d1f536d4330"
	result := "true"
	s.registerResponse(result, func(body []byte) {
