  ...
  <div class="t-root">
    ...
    description="We will back in a flash">
      ...
      <div class="slot" slot="image">
          <svg class="maintenance" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 511.404 511.404" style="enable-background:new 0 0 511.404 511.404;" xml:space="preserve" width="512" height="512">
        <g>
...
export default {
  ...
  created(){
    log("maintenance-view::created");
  },
  mounted(){
    log("maintenance-view::mounted");
  },
  components: {
    'errorMessage': () => import('@/components/error')
  }
}
</script>
