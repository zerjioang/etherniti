<template>
  <body class="theme-methw">
    ...
    <div class="search-bar">
        ...
        <div class="close-search" v-on:click="hideSearchBar()">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">METHW: A High Performance Ethereum WebAPI</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li><a href="#" v-on:click="showSearchBar()" class="js-search" data-close="true"><i class="material-icons">search</i></a></li>
                    <!-- #END# Call Search -->
                    <!-- Notifications -->
                    <li class="dropdown">
