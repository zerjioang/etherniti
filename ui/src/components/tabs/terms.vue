<template>
	<div>
		...
		<p>
		    Our Terms of Use have been updated as of October 2017 IMPORTANT NOTICE: THIS AGREEMENT IS SUBJECT TO BINDING ARBITRATION AND A WAIVER OF CLASS ACTION RIGHTS AS DETAILED IN SECTION 14. PLEASE READ THE AGREEMENT CAREFULLY.
		</p>
		<h5>1. ACCEPTANCE OF TERMS</h5>
		<p>
		    ConsenSys AG's Infura (“Infura”) serves as a gateway to the decentralized internet by providing scalable access to the Ethereum blockchain and IPFS infrastructure. Infura hosts a website that serves as a registration portal, product offering, and an overview of the health of Infura services through our website located at: https://infura.io/ (the "Site") which includes text, images, audio, code and other materials or third party information. The Site and any other features, tools, materials, or services offered from time to time by Infura, including our network infrastructure, is referred to here as the “Service.” Please read these Terms of Use (the “Terms” or “Terms of Use”) carefully before using the Service. By using or otherwise accessing the Services, or clicking to accept or agree to these Terms where that option is made available, you (1) accept and agree to these Terms (2) consent to the collection, use, disclosure and other handling of information as described in our Privacy Policy and (3) any additional terms, rules and conditions of participation issued by Infura from time to time. If you do not agree to the Terms, then you may not access or use the Services.
		</p>

		<h5>2. MODIFICATION OF TERMS OF USE</h5>
		<p>
		    Except for Section 14, providing for binding arbitration and waiver of class action rights, Infura reserves the right, at its sole discretion, to modify or replace the Terms of Use at any time. The most current version of these Terms will be posted on our Site. You shall be responsible for reviewing and becoming familiar with any such modifications. Use of the Services by you after any modification to the Terms constitutes your acceptance of the Terms of Use as modified.
		</p>
		...
		<p>
		    ...
		    <br>
		    Additionally, you acknowledge and agree that you (and not ConsenSys) are responsible for obtaining and maintaining all telecommunications, broadband, and computer hardware, equipment, and services needed to access and use the Website, and paying all charges related thereto.
		</p>

		<h5>6. REPRESENTATIONS, WARRANTIES AND RISKS</h5>
		<h6>6.1. Warranty disclaimer</h6>
		<p>
		    You expressly understand and agree that your use of the Service is at your sole risk. The Service is provided on an "AS IS" and "as available" basis, without warranties of any kind, either express or implied, including, without limitation, implied warranties of merchantability, fitness for a particular purpose or non-infringement. You release Infura from all liability for content you acquired or failed to acquire through the Service.
		</p>

		<h6>6.2 Sophistication and Risk of Cryptographic Systems</h6>
		<p>
		...
		<h6>6.3 Platform Security</h6>
		<p>
		    Infura is an early stage platform. You acknowledge that Ethereum applications are code subject to flaws and acknowledge that you are solely responsible for evaluating any available code provided by the Services. You further expressly acknowledge and represent that Ethereum applications can be written maliciously or negligently, that Infura cannot be held liable for your interaction with such applications and that such applications may cause loss of property or identity. These warnings and others later provided by Infura in no way evidence or represent an on-going duty to alert you to all of the potential risks of utilizing the Service or Content.
		</p>

		<h5>7. INDEMNITY</h5>
		<p>
		    You agree, to the fullest extent permitted by applicable law, to release and to indemnify, defend and hold harmless Infura and its parents, subsidiaries, affiliates and agencies, as well as the officers, directors, employees, shareholders and representatives of any of the foregoing entities, from and against any and all losses, liabilities, expenses, damages, costs (including attorneys’ fees and court costs) claims or actions of any kind whatsoever arising or resulting from your use of the Service, your violation of these Terms of Use, and any of your acts or omissions that implicate publicity rights, defamation or invasion of privacy. Infura reserves the right, at its own expense, to assume exclusive defense and control of any matter otherwise subject to indemnification by you and, in such case, you agree to cooperate with Infura in the defense of such matter.
		</p>

		<h5>8. LIMITATION ON LIABILITY</h5>
		<p>
		    YOU ACKNOWLEDGE AND AGREE THAT YOU ASSUME FULL RESPONSIBILITY FOR YOUR USE OF THE SITES AND SERVICE. YOU ACKNOWLEDGE AND AGREE THAT ANY INFORMATION YOU SEND OR RECEIVE DURING YOUR USE OF THE SITES AND SERVICE MAY NOT BE SECURE AND MAY BE INTERCEPTED OR LATER ACQUIRED BY UNAUTHORIZED PARTIES. YOU ACKNOWLEDGE AND AGREE THAT YOUR USE OF THE SITES AND SERVICE IS AT YOUR OWN RISK. RECOGNIZING SUCH, YOU UNDERSTAND AND AGREE THAT, TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, NEITHER INFURA NOR ITS SUPPLIERS OR LICENSORS WILL BE LIABLE TO YOU FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, EXEMPLARY OR OTHER DAMAGES OF ANY KIND, INCLUDING WITHOUT LIMITATION DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA OR OTHER TANGIBLE OR INTANGIBLE LOSSES OR ANY OTHER DAMAGES BASED ON CONTRACT, TORT (INCLUDING, IN JURISDICTIONS WHERE PERMITTED, NEGLIGENCE AND GROSS NEGLIGENCE), STRICT LIABILITY OR ANY OTHER THEORY (EVEN IF INFURA HAD BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), RESULTING FROM THE SITE OR SERVICE; THE USE OR THE INABILITY TO USE THE SITES OR SERVICE; UNAUTHORIZED ACCESS TO OR ALTERATION OF YOUR TRANSMISSIONS OR DATA; STATEMENTS OR CONDUCT OF ANY THIRD PARTY ON THE SITES OR SERVICE; ANY ACTIONS WE TAKE OR FAIL TO TAKE AS A RESULT OF COMMUNICATIONS YOU SEND TO US; HUMAN ERRORS; TECHNICAL MALFUNCTIONS; FAILURES, INCLUDING PUBLIC UTILITY OR TELEPHONE OUTAGES; OMISSIONS, INTERRUPTIONS, LATENCY, DELETIONS OR DEFECTS OF ANY DEVICE OR NETWORK, PROVIDERS, OR SOFTWARE (INCLUDING, BUT NOT LIMITED TO, THOSE THAT DO NOT PERMIT PARTICIPATION IN THE SERVICE); ANY INJURY OR DAMAGE TO COMPUTER EQUIPMENT; INABILITY TO FULLY ACCESS THE SITES OR SERVICE OR ANY OTHER WEBSITE; THEFT, TAMPERING, DESTRUCTION, OR UNAUTHORIZED ACCESS TO, IMAGES OR OTHER CONTENT OF ANY KIND; DATA THAT IS PROCESSED LATE OR INCORRECTLY OR IS INCOMPLETE OR LOST; TYPOGRAPHICAL, PRINTING OR OTHER ERRORS, OR ANY COMBINATION THEREOF; OR ANY OTHER MATTER RELATING TO THE SITES OR SERVICE. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF CERTAIN WARRANTIES OR THE LIMITATION OR EXCLUSION OF LIABILITY FOR INCIDENTAL OR CONSEQUENTIAL DAMAGES. ACCORDINGLY, SOME OF THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU.
		</p>

		<xmp>
		9. LICENSE

		Subject to your compliance with these Terms of Use, Infura grants you a limited, non-exclusive, non-transferable, non-sublicensable license to access and make personal and non-commercial use of the Service. This license does not include any resale or commercial use of the Service or any derivative use of the Service. All rights not expressly granted to you in these Terms of Use are reserved and retained by Infura or its licensors. The Infura Service may not be reproduced, duplicated, copied, sold, resold, visited, or otherwise exploited for any commercial purpose without express written consent of Infura. You may not frame or utilize framing techniques to enclose any trademark, logo, or other proprietary information (including images, text, page layout, or form) of Infura without express written consent. You may not misuse the Services. You may use the Services only as permitted by law. The licenses granted by Infura terminate if you do not comply with these Terms of Use.
		...
		You have the right to opt-out and not be bound by the arbitration and class action waiver provisions set forth above by sending written notice of your decision to opt-out to the following address: Infura ℅ ConsenSys, 49 Bogart Street, Brooklyn NY 11206 and via email at notices@consensys.net, with subject line INFURA LEGAL OPT OUT. The notice must be sent within 30 days of your first use of the Service, whichever is later, otherwise you shall be bound to arbitrate disputes in accordance with the terms of those paragraphs. If you opt-out of these arbitration provisions, Infura also will not be bound by them.

		13.7 Changes to this Section

		Infura will provide 60-days’ notice of any changes to this section. Changes will become effective on the 60th day, and will apply prospectively only to any claims arising after the 60th day. For any dispute not subject to arbitration you and Infura agree to submit to the personal and exclusive jurisdiction of and venue in the federal and state courts located in New York, New York. You further agree to accept service of process by mail, and hereby waive any and all jurisdictional and venue defenses otherwise available. The Terms and the relationship between you and Infura shall be governed by the laws of the State of New York without regard to conflict of law provisions.

		14. GENERAL INFORMATION

		14.1 Entire Agreement

		These Terms (and any additional terms, rules and conditions of participation that Infura may post on the Service) constitute the entire agreement between you and Infura with respect to the Service and supersedes any prior agreements, oral or written, between you and Infura. In the event of a conflict between these Terms and the additional terms, rules and conditions of participation, the latter will prevail over the Terms to the extent of the conflict.

		14.2 Waiver and Severability of Terms

		The failure of Infura to exercise or enforce any right or provision of the Terms shall not constitute a waiver of such right or provision. If any provision of the Terms is found by an arbitrator or court of competent jurisdiction to be invalid, the parties nevertheless agree that the arbitrator or court should endeavor to give effect to the parties' intentions as reflected in the provision, and the other provisions of the Terms remain in full force and effect.
		...
		All Rights Reserved. Infura is currently exploring the appropriate license structure and this will be updated when a conclusion is reached.
		</xmp>
	</div>
</template>
